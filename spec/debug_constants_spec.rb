...
RSpec.describe 'ActiveAdmin input namespaces', type: :request do
  it 'prints available input namespaces' do
    ...
    mod_filters_inputs = defined?(ActiveAdmin::Filters::Inputs) ? ActiveAdmin::Filters::Inputs.constants : []
    mod_inputs_filters = defined?(ActiveAdmin::Inputs::Filters) ? ActiveAdmin::Inputs::Filters.constants : []
