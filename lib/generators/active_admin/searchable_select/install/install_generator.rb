    ...
    module Generators
      class InstallGenerator < Rails::Generators::Base
        ...
        class_option :bundler,
                     ...
                     enum: ['esbuild', 'importmap', 'webpack']
        
        def install_npm_package
          if options[:bundler] != 'importmap'
        ...
        def setup_esbuild
          ...
          if File.exist?('package.json')
            ...
            unless package_json['scripts'] && package_json['scripts']['build']
              say "Adding build script to package.json...", :green
              package_json['scripts'] ||= {}
              package_json['scripts']['build'] = 'esbuild app/javascript/*.* --bundle --sourcemap --format=esm --outdir=app/assets/builds --public-path=/assets'
        ...
        def setup_webpack
          ...
          if File.exist?(js_file)
            ...
            say "Please manually add the searchable_select import to your ActiveAdmin JavaScript pack", :yellow
          end
        end
      end
    end
